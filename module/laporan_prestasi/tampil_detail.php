                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <!--<p class="text-muted font-13 m-b-30">
                     ...
                     <a href="module/laporan_prestasi/cetak.php?idKelas=<?php echo $idKelas;?>" class="btn btn-warning btn-sm" target="_blank"><i class='fa fa-print'></i></button></a>
                    <table id="" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php
                        $siswa=mysqli_query($connect, "SELECT a.*, SUM(c.poin) as jml FROM siswa a join detail_poin b on a.nis=b.nis join prestasi c on b.id_prestasi=c.id_prestasi WHERE a.id_kelas='$idKelas' group BY a.nis order by jml desc");
                        $no=1;

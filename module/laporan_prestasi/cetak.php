...
$query = mysqli_query($connect,"SELECT a.*, SUM(c.poin) as jml FROM siswa a join detail_poin b on a.nis=b.nis join prestasi c on b.id_prestasi=c.id_prestasi WHERE a.id_kelas='$idKelas' group BY a.nis order by jml desc");
$html = ' <html>
...
<table border="0" style="width: 100%" cellspacing="0" cellpadding="0">
  ...
  <hr>
<center><h3><u>Laporan Prestasi</u></center> 

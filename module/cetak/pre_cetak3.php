              ...
              <div class="col-md-8 col-sm-8 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left input_mask" method="post" action="<?php echo $base_url; ?>main.php?module=cetak_sp3">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="date" name="hariTanggal" class="form-control" placeholder="Default Input">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Waktu (WIB)</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="time" name="waktu" class="form-control" placeholder="Default Input">
                        </div>
                      </div>

...
$siswa=mysqli_query($connect, "SELECT surat_sp_1.no_surat, surat_sp_1.nis, surat_sp_1.tanggal, surat_sp_1.jam, siswa.nama_siswa, kelas.tingkat_kelas, jurusan.nama_jurusan, kelas.sub_kelas, orang_tua.nama_ortu FROM surat_sp_1 join siswa ON surat_sp_1.nis=siswa.nis JOIN kelas ON siswa.id_kelas=kelas.id_kelas JOIN jurusan ON kelas.id_jurusan=jurusan.id_jurusan JOIN orang_tua ON siswa.id_ortu=orang_tua.id_ortu WHERE surat_sp_1.nis='$nis'");

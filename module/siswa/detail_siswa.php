                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                          ...
                          <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Prestasi</a>
                           ...
                           <li role="presentation" class=""><a href="#tab_content3" role="tab" id="absen-tab" data-toggle="tab" aria-expanded="false">Absensi</a>
                          </li>
                        </ul>
                        <div id="myTabContent" class="tab-content">
                          ...
                          <div role="tabpanel" class="tab-pane fade active in" id="tab_content3" aria-labelledby="absen-tab">
                                  <!-- start tabel pelanggaran -->
                      ...
                      <tbody>
                        <?php
                        $absensi=mysqli_query($connect, "SELECT * FROM absensi JOIN siswa ON absensi.nis=siswa.nis ORDER BY tanggal DESC");
                        $no=1;

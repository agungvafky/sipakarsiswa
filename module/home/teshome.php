          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Daftar Teratas </h2>
                    
                    <div class="clearfix"></div>
                  </div>
                  <form>
                     <div class="item form-group">
                          <label class="control-label col-md-0 col-sm-1 col-xs-1">TOP</label>
                          <div class="col-md-1 col-sm-1 col-xs-1">
                            <input type="number" name="top" class="form-control col-md-3" style="float: left;" required="required" />
                            <div style="position: relative; float: left; width: 50px; margin: 3px;"></div>
                          </div>
                        </div>
                      <button type="submit" class="btn btn-success" name="cek">Submit</button>
                  </form>
                  <?php
                     if(isset($_POST['cek']))
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                          ...
                          <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Prestasi Terbanyak</a>
                          </li>
                        </ul>
                      ...
                      <tbody>
                        <?php
                        $siswa=mysqli_query($connect, "SELECT a.*, SUM(c.poin) as jml FROM siswa a join detail_poin b on a.nis=b.nis join pelanggaran c on b.id_pelanggaran=c.id_pelanggaran group BY a.nis order by jml desc limit $top");
                        $no=1;
                      ...
                      <tbody>
                        <?php
                        $siswa=mysqli_query($connect, "SELECT a.*, SUM(c.poin) as jml FROM siswa a join detail_poin b on a.nis=b.nis join prestasi c on b.id_prestasi=c.id_prestasi group BY a.nis order by jml desc limit $top");
                        $no=1;
                        while($sw=mysqli_fetch_array($siswa)){
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                          <li role="presentation" class="active"><a href="#tab_content3" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Pelanggaran</a>
                          </li>
                          <li role="presentation" class=""><a href="#tab_content4" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Prestasi</a>
                          </li>
                        </ul>

                              ...
                              <div class="modal-body">
                                ...
                                <table class="table table-hover">
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <a href="main.php?module=cetak_spjadi1&nis=<?php echo $ulang1['nis']; ?>">
                              ...
                              <div class="modal-body">
                                ...
                                <table class="table table-hover">
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <a href="main.php?module=cetak_spjadi2&nis=<?php echo $ulang2['nis']; ?>">
                                        <button type="button" class="btn btn-primary btn-xs" ><i class='fa fa-print'></i> Cetak Ulang</button>
                                      </a>
                                    </td>
                                  </tr>
                              ...
                              <div class="modal-body">
                                ...
                                <table class="table table-hover">
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <a href="main.php?module=cetak_spjadi3&nis=<?php echo $ulang3['nis']; ?>">
                                        <button type="button" class="btn btn-primary btn-xs" ><i class='fa fa-print'></i> Cetak Ulang</button>
                                      </a>
                                    </td>
                                  </tr>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <tbody>
                        <?php
                        $siswa=mysqli_query($connect, "SELECT a.*, SUM(c.poin) as jml FROM siswa a join detail_poin b on a.nis=b.nis join pelanggaran c on b.id_pelanggaran=c.id_pelanggaran group BY a.nis order by jml desc ");
                        $no=1;
                      ...
                      <tbody>
                        <?php
                        $siswa=mysqli_query($connect, "SELECT a.*, SUM(c.poin) as jml FROM siswa a join detail_poin b on a.nis=b.nis join prestasi c on b.id_prestasi=c.id_prestasi group BY a.nis order by jml desc");
                        $no=1;
                        while($sw=mysqli_fetch_array($siswa)){

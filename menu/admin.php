  ...
  <h3>Pengawasan Siswa</h3>
    <ul class="nav side-menu">
      ...
      <li><a href="main.php?module=input_pelanggaran_siswa"><i class="fa fa-pencil-square-o"></i> Input Pelanggaran Siswa </a>
       ...
       <li><a href="main.php?module=input_absensi"><i class="fa fa-pencil-square-o"></i> Input absensi</a>
      </li>
      <li><a><i class="fa fa-newspaper-o"></i> Laporan <span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
          ...
          <li><a href="main.php?module=laporan_absensi">Laporan Absensi</a></li>
        </ul>
      </li>

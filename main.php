...
<html lang="en">
  <head>
    ...
    <title>Selamat Datang di Sistem Informasi Pengawasan Siswa SMKN 1 Ampek Angkek</title>
    <script language="JavaScript">
      var txt=":: Sistem Informasi Pengawasan Siswa ";
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
          ...
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="main.php?module=home" class="site_title">
                <div class="logo_pic"><img src="images/logo.jpeg" alt="..." class="img-lgkrn logo_img"></div>
        ...
        }elseif ($_GET['module'] == 'lap_absensi_ke_siswa') {
                include "module/laporan_absensi/laporan_ke_siswa.php";
        }

        elseif ($_GET['module'] == 'input_absensi') {
                include "module/absensi/form_tambah.php";
        }elseif ($_GET['module'] == 'edit_absensi') {
                include "module/absensi/form_edit.php";
        }
        ...
        elseif ($_GET['module'] == 'laporan_absensi') {
                include "module/laporan_absensi/tampil_laporan_absensi.php";
        }
        ...
        }elseif ($_GET['module'] == 'pre_cetak4') {
                include "module/cetak/pre_cetak4.php";
        }elseif ($_GET['module'] == 'cetak_sp') {
                include "module/cetak/surat.php";
        }elseif ($_GET['module'] == 'cetak_sp2') {
                include "module/cetak/surat2.php";
        }elseif ($_GET['module'] == 'cetak_sp3') {
                include "module/cetak/surat3.php";
        }elseif ($_GET['module'] == 'cetak_spjadi1') {
                include "module/cetak/suratjadi1.php";
        }elseif ($_GET['module'] == 'cetak_spjadi2') {
                include "module/cetak/suratjadi2.php";
        }elseif ($_GET['module'] == 'cetak_spjadi3') {
                include "module/cetak/suratjadi3.php";
        }
        ...
        <footer>
          <div class="pull-right">
             Sistem Informasi Pengawasan Siswa - SMKN 1 Ampek Angkek &copy; Yutika Afrelia
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
